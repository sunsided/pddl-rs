...
/// # use pddl::parsers::domain::{parse_name, atomic_formula};
/// # use pddl::types::domain::{AtomicFormula, EqualityAtomicFormula, Name, PredicateAtomicFormula, PrimitiveType, Type, Typed, Predicate};
///
